...
#gcc -c -o function_test.o -Wall -Wextra -Werror -I/home/chris/src/ehsmBB/include $SgxSSL_Link_Libraries -fPIC function_test.cpp

#gcc -c -o main.o -Wall -Wextra -Werror -I/home/chris/src/ehsmBB/include $(pkg-config --cflags gtk+-2.0 libxml-2.0) $(SgxSSL_Link_Libraries) -fPIC main.cpp
#gcc $(SgxSSL_Link_Libraries) -o main function_test.o main.o
